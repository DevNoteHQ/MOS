...
namespace System::Info
{
	...
	const uint64_t BSSStartAddress =	&_bss_start;	//Returns the BSS-Start-Address at 1M + HVMA + Binary-Size + Data-Size + 4k Alignment 
	const uint64_t BSSEndAddress =		&_bss_end;		//Returns the BSS-End-Address at 1M + HVMA + Binary-Size + Data-Size + BSSSize
